  ...
  function bindInteractiveUI(row, admin) {
    ...
    row.querySelector(".restore").onclick = () => {
      openActionModal({
        ...
        desc: "This will restore ALL admin accounts to the most recent safe version. Any changes made since the last snapshot will be permanently lost. This action takes effect immediately.",
        onConfirm: async () => {
          try {
